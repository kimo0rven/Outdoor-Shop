"""
Django settings for AginodOutdoorShop project.
...
SECRET_KEY = 'django-insecure-7==48mh%dsyp4gixjd_=48l2s_rwzw=euswm7p7^5l23ixlu-('
...
ROOT_URLCONF = 'AginodOutdoorShop.urls'
...
WSGI_APPLICATION = 'AginodOutdoorShop.wsgi.application'
